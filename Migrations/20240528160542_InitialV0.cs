        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalesGoal = table.Column<int>(type: "int", nullable: false),
                    SalesPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesDatas", x => x.SalesDataId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesProducts", x => new { x.SalesDataId, x.ProductId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesProducts_SalesDatas_SalesDataId",
                        column: x => x.SalesDataId,
                        principalTable: "SalesDatas",
                        principalColumn: "SalesDataId",
                        onDelete: ReferentialAction.Cascade);
                });
